...
LIB_SOURCES := src/arena.cpp src/arena_support.cpp src/arena_verifier.cpp \
               src/compiler_support.cpp src/dead_code_elimination.cpp \
...
TEST_SOURCES := tests/test_arena_verifier.cpp \
